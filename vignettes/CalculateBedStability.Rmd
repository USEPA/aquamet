...
subcharOut <- nrsaSubstrateCharacterization (bBottomDom = subset(littoralEx, PARAMETER == 'BOTTOMDOM', select=c(SITE,TRANSECT,VALUE))
                                    ...
                                    ,wSizeClass = subset(channelxsectEx, PARAMETER == 'SIZE_CLS', select=c(SITE,BANK,TRANSECT,VALUE))
                                    ,wMezzoSizeClass = subset(channelxsectEx, PARAMETER == 'XSIZE_CLS', select=c(SITE,BANK,TRANSECT,VALUE))
)
