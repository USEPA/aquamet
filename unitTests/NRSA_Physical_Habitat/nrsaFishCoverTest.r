...
nrsaFishCoverTest <- function ()
{
  ...
  # debugging.
  testDataResult <- nrsaFishCover(algae = testData %>% subset(PARAMETER=='ALGAE') %>% select(SITE, TRANSECT, VALUE)
                                 ,boulder = testData %>% subset(PARAMETER=='BOULDR') %>% select(SITE, TRANSECT, VALUE)
                                 ,brush = testData %>% subset(PARAMETER=='BRUSH') %>% select(SITE, TRANSECT, VALUE)
                                 ,liveTree = testData %>% subset(PARAMETER=='LVTREE') %>% select(SITE, TRANSECT, VALUE)
                                 ,macrophytes = testData %>% subset(PARAMETER=='MACPHY') %>% select(SITE, TRANSECT, VALUE)
                                 ,overhang = testData %>% subset(PARAMETER=='OVRHNG') %>% select(SITE, TRANSECT, VALUE)
                                 ,structures = testData %>% subset(PARAMETER=='STRUCT') %>% select(SITE, TRANSECT, VALUE)
                                 ,undercut = testData %>% subset(PARAMETER %in% c('UNDCUT','UNDERCUT')) %>% select(SITE, TRANSECT, VALUE)
                                 ,woodyDebris = testData %>% subset(PARAMETER=='WOODY') %>% select(SITE, TRANSECT, VALUE)
                                 )
  ...
  testDataResult.River <- nrsaFishCover(algae = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='ALGAE') %>% select(SITE, TRANSECT, VALUE)
                                        ,boulder = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='BOULDR') %>% select(SITE, TRANSECT, VALUE)
                                        ,brush = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='BRUSH') %>% select(SITE, TRANSECT, VALUE)
                                        ,liveTree = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='LVTREE') %>% select(SITE, TRANSECT, VALUE)
                                        ,macrophytes = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='MACPHY') %>% select(SITE, TRANSECT, VALUE)
                                        ,overhang = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='OVRHNG') %>% select(SITE, TRANSECT, VALUE)
                                        ,structures = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='STRUCT') %>% select(SITE, TRANSECT, VALUE)
                                        ,undercut = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER %in% c('UNDCUT','UNDERCUT')) %>% select(SITE, TRANSECT, VALUE)
                                        ,woodyDebris = testData %>% subset(SITE %in% c('1','2','3','4','5') & PARAMETER=='WOODY') %>% select(SITE, TRANSECT, VALUE)
                                        )
  ...
  testDataResult.Stream <- nrsaFishCover(algae = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='ALGAE') %>% select(SITE, TRANSECT, VALUE)
                                       ,boulder = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='BOULDR') %>% select(SITE, TRANSECT, VALUE)
                                       ,brush = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='BRUSH') %>% select(SITE, TRANSECT, VALUE)
                                       ,liveTree = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='LVTREE') %>% select(SITE, TRANSECT, VALUE)
                                       ,macrophytes = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='MACPHY') %>% select(SITE, TRANSECT, VALUE)
                                       ,overhang = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='OVRHNG') %>% select(SITE, TRANSECT, VALUE)
                                       ,structures = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='STRUCT') %>% select(SITE, TRANSECT, VALUE)
                                       ,undercut = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER %in% c('UNDCUT','UNDERCUT')) %>% select(SITE, TRANSECT, VALUE)
                                       ,woodyDebris = testData %>% subset(SITE %in% c('6','7','8','9','10') & PARAMETER=='WOODY') %>% select(SITE, TRANSECT, VALUE)
                                       )
