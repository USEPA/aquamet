metsLargeWoody <- function(thalweg, channelgeometry, bankgeometry, wood, visits) {

################################################################################
# Function: metsLargeWoody
...
#   the successful case, a csv file named "metsLargeWoody.csv" containing
...
# xbkf_w
  ...
  bankgeomean <- subset(df3, toupper(METRIC)=='XBKF_W')
