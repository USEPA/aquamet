...
#          test prevented this from being seen.  Modified dataframe of expected
#          values for ltmxdbh at EPA01-0159.
...
metsLegacyTreeTest <- function()
{
  ...
  checkEquals(NULL, bb, "Error: metsLegacyTree character metrics are broken")
...
# Test metrics from SAS were corrected for known errors, including the
# following:
# EPA01-0124 ltmxdist was 1, should be 3
# EPA01-0144 ltmxdist was 1, should be 15
# EPA01-0167 ltmxdist was 16, should be 20
# EPA01-0159 ltmxdbh was '.1-.3', should be '.3-.75'
{
bob <- textConnection(
"UID METRIC RESULT
