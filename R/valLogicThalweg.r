...
#          instead.
#  1/12/11 cws Added imageExist = constructImageLocation argument to call of
#          constructNRSAValidationResults to reflect recent change to that
#          function.
#
...
#
{
  ...
  if(is.null(logicResults)) {
      ...
      vv <- constructNRSAValidationResults(logicResults, meta.df, siteInfo, imageExist = constructImageLocation)
  }
