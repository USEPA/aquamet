...
# 10/12/10 mrc.. failed tests.  reordered testData output, fixed problem.  The reordering
#          occurred in the output from the "unexpected row count"
...
#                                                         )
  ...
  ee <- rbind("Column UID has 1 missing values"
             ...
             ,"Column RESULT has 5 non-numeric values"
